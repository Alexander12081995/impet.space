        ...
        <div className={css.container} id="counter">
            ...
            <div className={css.leftBlock}>
                <div className={css.textBlock}>
                    ...
                    <div>
                        <p className={css.text}>Наше сообщество стремительно растет и развивается. Наша команда это
                            целеустремленные, доброжелательные и активные люди, которые стремятся улучшить мир через
                            идеи.</p>
                    </div>
                </div>
